...
TYPE="flex_opt"
MODEL_LIST=("facebook/opt-6.7b") # "facebook/opt-2.7b" "facebook/opt-13b" "facebook/opt-30b")

FLEXGEN_PATH=$PWD/../../flexgen
for MODEL in ${MODEL_LIST[@]}
do
  for SCHEME in "ibp_compress" "ibp" #"infinigen"  "original" "flex-ibp" # #"ibp" "ibp_compress" #"infinigen" #"ibp" "ibp_compress" "infinigen"
  do
